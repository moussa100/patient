...
<section id="team" class="pb-5">
  <div class="container">
        <h5 class="section-title h1">LES DOCTEURS</h5>
        <div class="row">
           <?php
   require  'connex.php';
      $db = Database::db();
                       ...
                       <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">';
                                    ...
                                    echo '<h4 class="card-title">'.$items['prenom'].' '.$items['nom'].'</h4>';
                                    echo ' <p class="card-text">'.$items['adresse'].'</p>';
                                    echo ' <p class="card-text">'.$items['phone'].'</p>';
                                     echo ' <h5 class="card-text">'.$items['specialite'].'</h5>';
