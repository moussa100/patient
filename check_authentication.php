...
INNER JOIN secteur on secteur.id=service.idsecteur WHERE secrecteur.username=:username and secrecteur.password=:password";
			...
			if($count == 1 && !empty($row)) {
				...
				$_SESSION['sess_adresse'] = $row['adresse'];
				$_SESSION['sess_phone'] = $row['phone'];
				$_SESSION['sess_avatar'] = $row['avatar'];
